...
export default class Register extends Component {
  ...
  handleRegister = e => {
    ...
    const registerEmail = document.getElementById("username").value;
  ...
  render() {
    return (
      <React.Fragment>
        ...
        >
          <source
            src="https://s3.amazonaws.com/nfl-api-images/videos/Titans+Register.mp4"
            type="video/mp4"
          />
        </video>
        ...
        <Container>
          <div className="content">
            <form onSubmit={this.handleRegister} id="registerForm">
              ...
              {/* register button */}
              <button
                className="bd-tw-button button is-info is-small is-focused is-rounded is-fullwidth"
                type="submit"
                id="registerBtn"
              >
                Register
            ...
            <div id="backToLoginBtn">
              <button
                className="bd-tw-button button is-danger is-small is-focused is-rounded is-fullwidth"
                type="button"
                id="signUpBtn"
              >
